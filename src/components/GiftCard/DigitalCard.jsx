 ...
 *
 * Estilo enmarcado y sobrio: un badge translúcido con punto verde de estado
 * (cardData.estadoPill), foto con recorte inferior redondeado y un degradado
 * sutil —nada de neón—. Alto impacto pero serio.
 *
  ...
  return (
    <div className="flex h-full w-full flex-col bg-neutral-950 text-white">
      ...
      <div className="relative h-[55%] w-full overflow-hidden rounded-b-3xl">
        ...
        {card.estadoPill && (
          <div className="absolute bottom-3 left-4 flex items-center gap-1.5 rounded-full
